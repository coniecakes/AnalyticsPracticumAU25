...
client49_tree <- rpart::rpart(WorkType ~ WorkCategory + Problem + Priority + SourceType, 
                              data = client49_data, method = "class", 
                              control = rpart.control(cp = 0.02, maxdepth = 5, minsplit = 50))
