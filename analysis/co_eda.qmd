...
work_order_filtered <- work_order %>% 
  dplyr::select(ClientXref, WorkCategory, Problem, WorkType, Priority, SourceType, assetid)

cols_to_factor <- c("ClientXref", "WorkCategory", "Problem", "WorkType", "Priority", "SourceType", "assetid")
